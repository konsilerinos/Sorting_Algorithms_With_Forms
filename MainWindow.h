...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->программаToolStripMenuItem->Size = System::Drawing::Size(65, 20);
			this->программаToolStripMenuItem->Text = L"Program";
			// 
			// выходToolStripMenuItem
			// 
			this->выходToolStripMenuItem->Name = L"выходToolStripMenuItem";
			this->выходToolStripMenuItem->Size = System::Drawing::Size(93, 22);
			...
			this->разработчикToolStripMenuItem->Text = L"Developer";
			this->разработчикToolStripMenuItem->Click += gcnew System::EventHandler(this, &MainWindow::разработчикToolStripMenuItem_Click);
			// 
			// Start_button
			// 
...
private: System::Void разработчикToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e);
};
}
